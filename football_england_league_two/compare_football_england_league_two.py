...
betfirst = pd.read_csv('football_england_league_two\\betfirst_football_england_league_two.csv')
betfirst['broker'] = 'betfirst'
betway = pd.read_csv('football_england_league_two\\betway_football_england_league_two.csv')
betway['broker'] = 'betway'
bwin = pd.read_csv('football_england_league_two\\bwin_football_england_league_two.csv')
bwin['broker'] = 'bwin'
circus = pd.read_csv('football_england_league_two\\circus_football_england_league_two.csv')
circus['broker'] = 'circus'
ladbrokes = pd.read_csv('football_england_league_two\\ladbrokes_football_england_league_two.csv')
ladbrokes['broker'] = 'ladbrokes'
napoleon = pd.read_csv('football_england_league_two\\napoleon_football_england_league_two.csv')
napoleon['broker'] = 'napoleon'
pinnacle = pd.read_csv('football_england_league_two\\pinnacle_football_england_league_two.csv')
pinnacle['broker'] = 'pinnacle'
unibet = pd.read_csv('football_england_league_two\\unibet_football_england_league_two.csv')
